...
public class StolleDowntimeDay {
    ...
    public StolleDowntimeDay(int idIn, int view) throws SQLException {
        ...
        frame15.setTitle("Stolle Downtime Day");
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    try {
                        ...
                        Object[] array = SQLiteConnection.MaintenanceStolleDowntimeReturnEntryByDate(selectedDate);
                        
                        
                        if(array[0] == null){
                            
                            SQLiteConnection.MaintenanceStolleDowntimeInsert(
                                    SQLiteConnection.MaintenanceStolleDowntimeGetHighestID(),
                                    date,
                            ...
                            SQLiteConnection.MaintenanceStolleDowntimeUpdate(date,
                                    Double.valueOf(Stolle11JTextField1.getText()),
                                    Double.valueOf(Stolle12JTextField1.getText()),
                                    Double.valueOf(Stolle21JTextField1.getText()),
                                    Double.valueOf(Stolle22JTextField1.getText()),
                    ...
                    frame15.dispose();
                    StolleDowntimeDay.createSummaryScreen();
        ...
        search  = new JButton("Search Mode");
            ...
            @Override
                ...
                try {
                        ...
                        Logger.getLogger(StolleDowntimeDay.class
        ...
        find  = new JButton("Find Record");
            ...
            @Override
                ...
                try {
                        ...
                        Object[] total = SQLiteConnection.MaintenanceStolleDowntimeGetNextEntryById(currentId);
        ...
        previous  = new JButton("Previous Record");
            ...
            @Override
                ...
                try {
                        ...
                        Object[] total = SQLiteConnection.MaintenanceStolleDowntimeGetPreviousEntryById(currentId);
...
//            optionPanel1.add(commentsBox);
            ...
            currentId = SQLiteConnection.MaintenanceStolleDowntimeGetHighestID();
                buttonsPanel.setBackground(Color.GRAY);
...
//            optionPanel1.add(commentsBox);
            ...
            outerPanel.add (
            new JTextArea(), BorderLayout.SOUTH);
        ...
        JPanel optionsPanel2 = new JPanel(new FlowLayout());
            ...
            commentsPanel2.setBorder (

            new EmptyBorder(10, 10, 10, 10));
            commentsPanel2.add (

            new JLabel("Comment :  "), BorderLayout.WEST);
            ...
            SQLiteConnection.AnalyticsUpdate (
    ...
    private void setLastEntry() {
        ...
        try {
            total = SQLiteConnection.MaintenanceStolleDowntimeReturnEntryByID(highestID);
        } catch (Exception e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        }
    ...
    public static void createSummaryScreen() throws SQLException {
        ...
        ExportToExcel.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                StolleDowntimeDay.exportToExcel();

            }
        });

        // Outer Frame
        frameSummary = new JFrame("Stolle Downtime Day");
        ...
        JPanel summaryPanel = SQLiteConnection.MaintenanceStolleDowntimeSummaryTable(1);
...
//        });
    ...
    public void setStolleDowntimeToID(int idIn) {
        ...
        try {
            ...
            Object[] total = SQLiteConnection.MaintenanceStolleDowntimeReturnEntryByID(currentId);
    ...
    public static void exportToExcel() {
        ...
        export.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                query = "SELECT * FROM MainStolleDowntime WHERE Date BETWEEN \'" + modifiedDate1 + "\' AND \'" + modifiedDate2 + "\' ORDER BY " + sortTypesCombo.getSelectedItem() + ";";
