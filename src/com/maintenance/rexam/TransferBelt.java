...
public class TransferBelt {
    ...
    public TransferBelt(int spIn) throws SQLException {
        ...
        JFrame frame = new JFrame("Transfer Belt");
    ...
    private static void setToMachineCode(int machineCodeIn) {
        ...
        try {
            ...
            machineCodeArray = SQLiteConnection.MaintenanceTransferBeltReturnEntryByID(machineCodeIn);
            ...
            Logger.getLogger(TransferBelt.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private static void updateEntry(int machineCodeIn) {
        ...
        try {
            SQLiteConnection.MaintenanceTransferBeltUpdate(
