...
public class OtherEntryMenu {
	...
	public static JPanel createTopPanel(int viewIn) {
		...
		previous.addActionListener(new ActionListener() {
			...
			try {
				if(CurrentNCRNumber > SQLiteConnection.NCRGetHighestNCRNumber()){CurrentNCRNumber = SQLiteConnection.NCRGetHighestNCRNumber();}
			}
		...
		next.addActionListener(new ActionListener() {
			...
			if(CurrentNCRNumber == 0){CurrentNCRNumber = 1;}
