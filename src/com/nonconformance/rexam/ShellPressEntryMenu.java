...
public class ShellPressEntryMenu {
    ...
    public static JPanel createCenterPanel() {
        ...
        beforeJTextArea = new JTextArea();
        actionTakenJTextArea = new JTextArea();
    ...
    public static void createShellPressForm(String NCRNumber) throws JRException, IOException, PrinterException, SQLException {
        ...
        File file = new File("C:/Users/Chris/Documents/SPRING/Rexam4/src/com/nonconformance/rexam/PressNCRForm.jrxml");
        ...
        JasperExportManager.exportReportToPdfFile(print, "Reports/Press/ShellPressNCRReport" + NCRNumber + ".pdf");

        PDDocument pdf = PDDocument.load("Reports/Press/ShellPressNCRReport" + NCRNumber + ".pdf");
        pdf.print();
        pdf.close();
