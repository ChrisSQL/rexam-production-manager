...
public class LinerEntryMenu {
    ...
    static JTextArea beforeHead1JTextArea, beforeHead2JTextArea, beforeHead3JTextArea, beforeHead4JTextArea, beforeHead5JTextArea,
            ...
            afterHead4JTextArea, afterHead5JTextArea, afterHead6JTextArea, afterHead7JTextArea, afterHead8JTextArea, actionTakenJTextArea2, defectJTextArea, defectJTextArea2;
    ...
    public LinerEntryMenu(int viewIn) {
        ...
        SQLiteConnection.AnalyticsUpdate("LinerEntryMenu");
    }
    ...
    public static JPanel createTopPanel(int viewIn) {
        ...
        JPanel upperPanel = new JPanel(new GridLayout(1, 6));

        upperPanel.add(new JLabel(" Defect ", JLabel.CENTER));
        upperPanel.add(defectCombo);
        upperPanel.add(new JLabel(" General ", JLabel.CENTER));
        upperPanel.add(generalCombo);
        upperPanel.add(new JLabel(" Area of Origin  ", JLabel.CENTER));
        upperPanel.add(areaOfOriginCombo);
        defectPanel.add(upperPanel, BorderLayout.NORTH);
        ...
        JPanel defectPanelBottom = new JPanel(new GridLayout(1, 2));
        JPanel panelLeft = new JPanel(new BorderLayout());
        panelLeft.add(new JLabel(" Causes "), BorderLayout.WEST);
        panelLeft.add(sp, BorderLayout.CENTER);
        JPanel panelRight = new JPanel(new BorderLayout());
        panelRight.add(new JLabel(" Action "), BorderLayout.WEST);
        panelRight.add(sp2, BorderLayout.CENTER);
        defectPanelBottom.add(panelLeft);
        defectPanelBottom.add(panelRight);

        defectPanel.add(defectPanelBottom, BorderLayout.SOUTH);
        ...
        //    panel.add(new JLabel("CCC", JLabel.CENTER));
        //    panel.add(new JLabel("DDD", JLabel.CENTER));
        ...
        //    panel.add(new JLabel("AAA", JLabel.CENTER));
        //    panel.add(new JLabel("BBB", JLabel.CENTER));
        if (viewIn == -1) {
            //outerPanel.add(optionsPanel, BorderLayout.NORTH);
            outerPanel.add(panel, BorderLayout.NORTH);
            outerPanel.add(defectPanel, BorderLayout.SOUTH);
        } else if (viewIn == 1) {
    ...
    public static JPanel createBottomPanel(int viewIn) {
        ...
        delete.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    SQLiteConnection.NCRLinerDelete(CurrentNCRNumber);
