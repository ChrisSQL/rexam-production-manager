...
public class PlantSpoilage2 {
	...
	/* Line 2 */static JLabel lineLabel20, shellPressMod1Label, shellPressMod2Label, shellPressMod3Label, shellPressTotals1Label, shellPressMod4Label, shellPressTotals2Label;
	/* Line 3 */static JTextField shellPressMod1JTextField, shellPressMod2JTextField, shellPressMod3JTextField, B64TotalJTextField, shellPressMod4JTextField,
			shellPressTotalJTextField;
	/* Line 4 */static JLabel lineLabel22, linerMod1Label, linerMod2Label, linerMod3Label, linerTotals1Label, linerMod4Label, linerTotals2Label;
	/* Line 5 */static JTextField linerMod1JTextField, linerMod2JTextField, linerMod3JTextField, linerTotals1JTextField, linerMod4JTextField, linerTotals2JTextField;
	/* Line 6 */static JLabel lineLabel24, stolleMod1Label, stolleMod2Label, stolleMod3Label, stolleTotals1Label, stolleMod4Label, stolleTotals2Label;
	/* Line 7 */static JTextField stolleMod1JTextField, stolleMod2JTextField, stolleMod3JTextField, stolleTotals1JTextField, stolleMod4JTextField, stolleTotals2JTextField;
	/* Line 8 */static JLabel lineLabel26, lineLabel8, lineLabel9, lineLabel10, lineLabel11, lineLabel12, lineLabel13, spoilageByArea;
	/* Line 9 */static JLabel shellPressLabel;
	/* Line 9 */static JTextField shellPressJTextField1, shellPressJTextField2, shellPressJTextField3, shellPressJTextFieldTotal1, shellPressJTextField4,
			shellPressJTextFieldTotal2;
	/* Line 10 */static JLabel ABalancerLabel;
	/* Line 10 */static JTextField ABalancerJTextField1, ABalancerJTextField2, ABalancerJTextField3, ABalancerJTextFieldTotal1, ABalancerJTextField4, ABalancerJTextFieldTotal2;
	/* Line 11 */static JLabel LinersLabel;
	/* Line 11 */static JTextField LinersJTextField1, LinersJTextField2, LinersJTextField3, LinersJTextFieldTotal1, LinersJTextField4, LinersTextFieldTotal2;
	/* Line 12 */static JLabel BBalancerLabel;
	/* Line 12 */static JTextField BBalancerJTextField1, BBalancerJTextField2, BBalancerJTextField3, BBalancerJTextFieldTotal1, BBalancerJTextField4, BBalancerTextFieldTotal2;
	/* Line 13 */static JLabel conversionPressLabel;
	/* Line 13 */static JTextField conversionPressJTextField1, conversionPressJTextField2, conversionPressJTextField3, conversionPressJTextFieldTotal1, conversionPressJTextField4,
			conversionPressTextFieldTotal2;
	/* Line 14 */static JLabel autoBaggersLabel;
	/* Line 14 */static JTextField autoBaggersJTextField1, autoBaggersJTextField2, autoBaggersJTextField3, autoBaggersJTextFieldTotal1, autoBaggersJTextField4,
			autoBaggersTextFieldTotal2;
	/* Line 15 */static JLabel QCChecksLabel;
	/* Line 15 */static JTextField QCChecksJTextField1, QCChecksJTextField2, QCChecksJTextField3, QCChecksJTextFieldTotal1, QCChecksJTextField4, QCChecksTextFieldTotal2;
	/* Line 16 */static JLabel TotalLineLabel;
	/* Line 16 */static JTextField TotalLineJTextField1, TotalLineJTextField2, TotalLineJTextField3, TotalLineJTextFieldTotal1, TotalLineJTextField4, TotalLineTextFieldTotal2;
	/* Line 17 */static JLabel HFILabel;
	/* Line 17 */static JTextField HFIJTextField1, HFIJTextField2, HFIJTextField3, HFIJTextFieldTotal1, HFIJTextField4, HFITextFieldTotal2;
	/* Line 18 */static JLabel OtherLabel;
	/* Line 18 */static JTextField OtherJTextField1, OtherJTextField2, OtherJTextField3, OtherJTextFieldTotal1, OtherJTextField4, OtherTextFieldTotal2;
	/* Line 19 */static JLabel finalTotalLabel;
	/* Line 19 */static JTextField finalTotalJTextField1, finalTotalJTextField2, finalTotalJTextField3, finalTotalJTextFieldTotal1, finalTotalJTextField4,
			finalTotalTextFieldTotal2;
	/* Line 20 */static JLabel lineLabel14, lineLabel15, lineLabel16, lineLabel17, lineLabel18, lineLabel19;
	/* Line XXX */static JLabel lineLabel21, lineLabel23, lineLabel25, lineLabel27, lineLabel28;
