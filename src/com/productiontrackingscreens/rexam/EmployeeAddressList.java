...
public class EmployeeAddressList {
	...
	static JLabel employeeId, name, address, crew, departmentHead, shiftManager, technician, operator, engineer, packer, qcInspector, phoneNumber,
			mobileNumber;
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					SQLiteConnection.EmployeeGetHighestID() + 1, employeeIdText.getText(), nametext.getText(), addressText.getText(),
							(String) crewCombo.getSelectedItem(), departmentHeadJCheckBox.isSelected(),
							shiftManagerJCheckBox.isSelected(), technicianJCheckBox.isSelected(),
							operatorJCheckBox.isSelected(), engineerJCheckBox.isSelected(),
							packerJCheckBox.isSelected(), qcInspectorJCheckBox.isSelected(), phoneNumberText.getText(),
		...
		nameCombo.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					phoneNumberText.setText(result[12] + "");
					mobileNumberText.setText(result[13] + "");
				}
				catch (Exception e1) {
		...
		confirmUpdate.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					employeeIdText.getText(), nametext.getText(), addressText.getText(), crewCombo.getSelectedItem() + "",
							departmentHeadJCheckBox.isSelected(), shiftManagerJCheckBox.isSelected(), technicianJCheckBox.isSelected(),
							operatorJCheckBox.isSelected(), engineerJCheckBox.isSelected(), packerJCheckBox.isSelected(),
							qcInspectorJCheckBox.isSelected(), phoneNumberText.getText(), mobileNumberText.getText(), id);
