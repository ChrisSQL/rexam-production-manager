...
public class BalancerMaintenanceModel {
	
	private String machineCode, machineName;
	
	private Date lastMaintenanceDate1, lastMaintenanceDate2, lastMaintenanceDate3, lastMaintenanceDate4, lastMaintenanceDate5,
	...
	private int ID, production1, production2, production3, production4, production5, production6, production7,
	...
	public BalancerMaintenanceModel(String machineCode, String machineName, Date lastMaintenanceDate1,
			Date lastMaintenanceDate2, Date lastMaintenanceDate3, Date lastMaintenanceDate4, Date lastMaintenanceDate5,
			Date lastMaintenanceDate6, Date lastMaintenanceDate7, Date maintenanceDueDate1, Date maintenanceDueDate2,
			Date maintenanceDueDate3, Date maintenanceDueDate4, Date maintenanceDueDate5, Date maintenanceDueDate6,
			Date maintenanceDueDate7, int iD, int production1, int production2, int production3, int production4,
			int production5, int production6, int production7, int targetProduction1, int targetProduction2,
			int targetProduction3, int targetProduction4, int targetProduction5, int targetProduction6,
			int targetProduction7) {
	...
	public BalancerMaintenanceModel(){
