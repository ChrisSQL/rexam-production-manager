...
public class ProductionWeeklyReportView extends JFrame{
	
	private ProductionWeeklyReportDAO productionWeeklyReportDAO;
	private JLabel b64Label, shellsProducedLabel1, endsPackedLabel1, HFIOpeningLabel1, HFICreatedLabel1, HFIRecoveredLabel1, HFIScrappedLabel1, HFIRemainingLabel1, HFISpoilageLabel1,
	...
	calculateLabel3, cdlLabel, shellsProducedLabel2, endsPackedLabel2, HFIOpeningLabel2, HFICreatedLabel2, HFIRecoveredLabel2, HFIScrappedLabel2, HFIRemainingLabel2, HFISpoilageLabel2,
	lineSpoilageLabel2, totalSpoilageLabel2, HFISpoilagePercentageLabel2, lineSpoilagePercentageLabel2, totalSpoilagePercentageLabel2, totalsLabel, shellsProducedLabel3, endsPackedLabel3, 
	HFIOpeningLabel3, HFICreatedLabel3, HFIRecoveredLabel3, HFIScrappedLabel3, HFIRemainingLabel3, HFISpoilageLabel3,
	...
	private JTextField b64TextField, endsPackedTextField1, shellsProducedTextField1, HFIOpeningTextField1, HFICreatedTextField1, HFIRecoveredTextField1, HFIScrappedTextField1, HFIRemainingTextField1, 
	HFISpoilageTextField1, lineSpoilageTextField1, totalSpoilageTextField1, HFISpoilagePercentageTextField1, lineSpoilagePercentageTextField1, totalSpoilagePercentageTextField1,cdlTextField, 
	endsPackedTextField2, totalsTextField, endsPackedTextField3, shellsProducedTextField2, HFIOpeningTextField2, HFICreatedTextField2, HFIRecoveredTextField2, HFIScrappedTextField2,HFIRemainingTextField2, 
	HFISpoilageTextField2, lineSpoilageTextField2, totalSpoilageTextField2, HFISpoilagePercentageTextField2, lineSpoilagePercentageTextField2, totalSpoilagePercentageTextField2, HFIOpeningTextField3, 
	HFICreatedTextField3, HFIRecoveredTextField3, HFIScrappedTextField3, HFIRemainingTextField3, HFISpoilageTextField3, lineSpoilageTextField3, totalSpoilageTextField3, HFISpoilagePercentageTextField3, 
	lineSpoilagePercentageTextField3, totalSpoilagePercentageTextField3, shellsProducedTextField3;
	private JButton calculateTotalSpoilage1, calculateTotalSpoilage2, calculateTotalSpoilage3, saveButton, backButton;
	private ProductionWeeklyReportModel pwm;
	
	public static void main(String[] args) {

		new ProductionWeeklyReportView(1, "August", "2015");

	}

	
	public ProductionWeeklyReportView(int idIn, String monthIn, String yearIn) {
		
		pwm = new ProductionWeeklyReportModel();
		
		ApplicationContext context = new ClassPathXmlApplicationContext("Spring-Module.xml");
		productionWeeklyReportDAO = (ProductionWeeklyReportDAO) context.getBean("ProductionWeeklyReportDAO");
		...
		initializeVariables(monthIn, yearIn, borderRed, borderBlue, borderYellow);

		setTitle("Production Weekly Report");
		setSize(800, 900);
   ...
   //             productionWeeklyReportDAO.AnalyticsUpdate("ProductionWeeklyReport");

	}


	private void initializeVariables(String monthIn, String yearIn, Border borderRed, Border borderBlue,
			Border borderYellow) {
		...
		shellsProducedTextField1.setText(productionWeeklyReportDAO.ProductionWeeklyReportTotalOptime2And3ForMonth(monthIn, yearIn) + "");
		
                
                endsPackedTextField1 = new JTextField();
		endsPackedTextField1.setEditable(false);
		endsPackedTextField1.setText(productionWeeklyReportDAO.ProductionWeeklyReportTotalAllW1And2And3sForMonth(monthIn, yearIn) + "");

		HFIOpeningTextField1 = new JTextField();
		HFIOpeningTextField1.setText(productionWeeklyReportDAO.ProductionWeeklyReportQuery(1) + "");
		...
		HFICreatedTextField1.setText(productionWeeklyReportDAO.ProductionWeeklyReportQuery(3) + "");
		...
		HFIRecoveredTextField1.setText(productionWeeklyReportDAO.ProductionWeeklyReportQuery(5) + "");
		...
		HFIScrappedTextField1.setText(productionWeeklyReportDAO.ProductionWeeklyReportQuery(7) + "");
		...
		lineSpoilageTextField1.setText(productionWeeklyReportDAO.ProductionWeeklyReportB64LineSpoilage(monthIn, yearIn) + "");
		...
		shellsProducedTextField2.setText(productionWeeklyReportDAO.ProductionWeeklyReportTotalOptime4ForMonth(monthIn, yearIn) + "");
		endsPackedTextField2 = new JTextField();
		endsPackedTextField2.setEditable(false);
		endsPackedTextField2.setText(productionWeeklyReportDAO.ProductionWeeklyReportTotalAllW4sForMonth(monthIn, yearIn) + "");

		HFIOpeningTextField2 = new JTextField();
		HFIOpeningTextField2.setText(productionWeeklyReportDAO.ProductionWeeklyReportQuery(2) + "");
		...
		HFICreatedTextField2.setText(productionWeeklyReportDAO.ProductionWeeklyReportQuery(4) + "");
		...
		HFIRecoveredTextField2.setText(productionWeeklyReportDAO.ProductionWeeklyReportQuery(6) + "");
		...
		HFIScrappedTextField2.setText(productionWeeklyReportDAO.ProductionWeeklyReportQuery(8) + "");
		...
		lineSpoilageTextField2.setText(productionWeeklyReportDAO.ProductionWeeklyReportCdlLineSpoilage(monthIn, yearIn) + "");
		...
		shellsProducedTextField3.setText(productionWeeklyReportDAO.ProductionWeeklyReportTotalOptime2And3And4ForMonth(monthIn, yearIn) + "");
		endsPackedTextField3 = new JTextField();
		endsPackedTextField3.setEditable(false);
		endsPackedTextField3.setText(productionWeeklyReportDAO.ProductionWeeklyReportTotalAllWs(monthIn, yearIn) + "");
		...
		lineSpoilageTextField3.setText(productionWeeklyReportDAO.ProductionWeeklyReportTotalLineSpoilage(monthIn, yearIn) + "");
	...
	public void updateRecord() {
		...
		productionWeeklyReportDAO.ProductionWeeklyReportUpdate(pwm);
